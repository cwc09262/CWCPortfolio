...
<body>
    <header>
        ...
        <div id="navbar" class="navbar">
            ...
            <div class="subnav">
                <button class="subnavbtn active">Seafarer Access<i class="fa fa-caret-down"></i></button>
                <div class="subnav-content">
    ...
    <div>
        <div class="subhead" style="top: 0;">
            <ul class="breadcrumb">
                ...
                <li>Seafarer Access</li>
                <li><a href="/subpages/policy.aspx">TWIC Escorts</a></li>
            </ul>
            <img src="/images/sub_head.png" alt="" id="example1">
            <h1>Seafarer Access</h1>
        </div>
        <main>
            <div class="bodyText" style="float: center;">
                <div class="left">
                    <div class="vertical-menu">
                        <a href="/subpages/policy.aspx">Policy</a>
                        <a class="active" href="/subpages/twic.aspx">TWIC Escorts</a>
                    </div>
                    ...
                    <div class="custom-card">
                        <div style="width: 100%">
                            <div class="diffRow">
                                ...
                                <div class="right">
                                    <a target="_blank" href="https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-101">33 CFR 101-106</a> -Maritime Security <br>
                                    <a target="_blank" href="https://www.ecfr.gov/current/title-33/chapter-I/subchapter-L/part-125">33 CFR 125</a> - Waterfront Facilities <br>
                                    <a target="_blank" href="https://www.ecfr.gov/current/title-46/chapter-I/subchapter-B/part-10"> 46 CFR 10, 12, & 15</a> - Merchant Marine Officers & Seamen
                                </div>
                            </div>
                            <div class="diffRow">
                                <div class="left">
