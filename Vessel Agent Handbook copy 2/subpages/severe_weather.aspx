...
<head>
    ...
    <title>Severe Weather Plan</title>
</head>
...
<body>
    <header>
        ...
        <div id="navbar" class="navbar">
            <div class="subnav">
                <button class="subnavbtn active">Maritime Traffic and Readiness <i class="fa fa-caret-down"></i></button>
    ...
    <div>
        <div class="subhead" style="top: 0;">
            <ul class="breadcrumb">
                ...
                <li>Maritime Traffic and Readiness</li>
                <li><a href="/subpages/vts.aspx">Severe Weather Plan</a></li>
            </ul>
            <img src="/images/sub_head.png" alt="" id="example1">
            <h1>Maritime Traffic and Readiness</h1>
        </div>
        <main>
            <div class="bodyText" style="float: center;">
                <div class="left">
                    <div class="vertical-menu">
                        <a  href="/subpages/vts.aspx">Vessel Traffic Service User Manual</a>
                        <a class="active" href="/subpages/severe_weather.aspx">Severe Weather Plan</a>
                    </div>
                ...
                <div class="right">
                    <iframe src="/documents/Hurricane and Severe Wx Plan CG ONLY.pdf" width="100%" height="816px">
