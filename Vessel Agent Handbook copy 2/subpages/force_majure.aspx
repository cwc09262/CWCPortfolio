    ...
    <div>
        <div class="subhead" style="top: 0;">
            <ul class="breadcrumb">
                ...
                <li>Hazards</li>
                <li><a href="/subpages/force_majure.aspx">Force Majeure</a></li>
            </ul>
            ...
            <div class="bodyText" style="float: center;">
                <div class="left">
                    <div class="vertical-menu">
                        <a href="/subpages/LOD.aspx">Letters of Deviation</a>
                        <a href="/subpages/op_controls.aspx">Operational Controls</a>
                        <a class="active" href="/subpages/force_majure.aspx">Force Majeure</a>
                        <a href="/subpages/pilot_ladder.aspx">Pilot Ladder</a>
                        <a href="/subpages/environ_threat.aspx">Environmental Threat</a>
                        <a href="/subpages/cyber_threat.aspx">Cyber Threat</a>
                    </div>
                    ...
                    <div class="contact-card">
                        <center>
                            ...
                            <div class="contact">
                                <h3>Sector New York Command Center</h3>
                ...
                <div class=" custom-card">
                    <div style="width: 100%">
                        <div class="diffRow">
                            ...
                            <div class="right">
                                <p>
                                    <a href="https://www.imo.org/en/About/Conventions/Pages/International-Convention-for-the-Safety-of-Life-at-Sea-(SOLAS),-1974.aspx">International Convention for the Safety of Life and Sea (SOLAS), 1974. Article IV</a>
                                </p>
                            </div>
                        </div>
                        <div class="diffRow">
